...
Status: DBase verifies and advertises providers separately from the upstream yt-dlp extractor list.

Source: https://github.com/yt-dlp/yt-dlp/blob/master/supportedsites.md

Generated: 2026-08-27.

yt-dlp includes extractors for many websites, and it can also try embedded media or the generic extractor for sites that are not listed. This document keeps the full upstream list close to the project, but a provider is only considered DBase-verified after metadata and at least one download path pass on Android and Windows.

## DBase Verified Providers
...
### yt-dlp upstream extractor list
